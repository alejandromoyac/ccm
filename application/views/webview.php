...
// This template can be used as a base for your webviews.
// by Pat Friedl
// https://braintrustinteractive.com/
// https://clkths.us/why-bots
header('X-Frame-Options: ALLOW-FROM https://*.messenger.com');
header('X-Frame-Options: ALLOW-FROM http://*.messenger.com');
...
<div class="container">
	...
	<h4 class="text-center">This is a Webview!</h4>
...
<footer class="footer">
	<button type="submit" id="done-btn" class="btn btn-primary btn-block">Done</button>
</footer>
